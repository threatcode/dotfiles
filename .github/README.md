...
For example, in my setup I've [set these variables](https://github.com/ThreatCode/dotfiles/blob/e839ab2d77f0be0d09b4f4ba3503c8b69ad925f3/config/zsh/.zshenv#L6=L10) to:
...
```bash
git clone --recursive git@github.com:ThreatCode/dotfiles.git ~/.dotfiles
...
└──.
   ...
   ├── <a href="https://github.com/ThreatCode/dotfiles/blob/master/lets-go.sh">lets-go.sh</a>            # One-line remote installation entry point
...
> [`zsh/aliases/git.zsh`](https://github.com/ThreatCode/dotfiles/blob/master/config/zsh/aliases/git.zsh)
...
> [`zsh/aliases/flutter.zsh`](https://github.com/ThreatCode/dotfiles/blob/master/config/zsh/aliases/flutter.zsh)
...
> [`zsh/aliases/rust.zsh`](https://github.com/ThreatCode/dotfiles/blob/master/config/zsh/aliases/rust.zsh) <br>
...
> [`zsh/aliases/node-js.zsh`](https://github.com/ThreatCode/dotfiles/blob/master/config/zsh/aliases/node-js.zsh)
...
> [`zsh/aliases/general.zsh`](https://github.com/ThreatCode/dotfiles/blob/master/config/zsh/aliases/general.zsh)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/ThreatCode/dotfiles/master/utils/web-search.sh)
```
